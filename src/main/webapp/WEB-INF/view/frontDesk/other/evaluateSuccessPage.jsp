...
<body>
    ...
    <a href="user/next/review" <c:if test="${hasNext}" > style="display: inline-block"</c:if> id="nextProductReviewPage" class="productReviewLink" title="评价下一个商品">
    ...
    <div id="theEvaluationDown" class="theEvaluationDown">
        <div class="theCumulativeAssessment">
            <div class="contentDiv">
                <span>累计评价</span>
                <span id="reviews">${orderItem.product.reviewNumber + 1}</span>
            </div>
